...
export class DataController {
  ...
  @ApiOperation({
    ...
    description:
      "Upload file data (CSV atau Excel) untuk diproses. Mendukung preview otomatis dan validasi.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Validasi data yang sudah diupload berdasarkan rules tertentu seperti required columns, data types, dan custom validation rules.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: "Export data",
    description:
      "Export data dalam format CSV, Excel, atau JSON dengan opsi filter, sorting, dan column selection.",
  })
  @ApiResponse({
    status: 200,
  ...
  async exportData(
    ...
    const filePath = await this.dataService.exportData(
      data,
      options,
      req.user.id,
      filename,
  ...
  @ApiOperation({
    ...
    description:
      "Mengambil template data untuk berbagai jenis import (karyawan, produk, dll).",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Preview isi file tanpa menyimpannya ke database untuk validasi awal.",
  })
  @ApiConsumes("multipart/form-data")
  @ApiResponse({
    status: 200,
